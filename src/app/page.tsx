					...
					<div className="flex flex-col items-center space-y-4 text-center">
						...
						<div className="space-y-2">
							...
							<p className="mx-auto max-w-[700px] text-gray-600 md:text-xl lg:text-2xl">
								No cards. No apps. No waiting. Carla's intelligent recognition
								system knows you're coming before you arrive.
							</p>
						</div>
				...
				<div className="container mx-auto px-4 md:px-6">
					<div className="flex flex-col items-center space-y-4">
						<p className="text-sm text-gray-500">
							Trusted by leading parking facilities
						</p>
					...
					<div className="grid gap-8 lg:grid-cols-3 lg:gap-12 items-start">
						...
						<div className="flex flex-col items-center space-y-4 text-center">
							...
							<div className="space-y-2">
								...
								<p className="text-gray-500">
									Advanced visual recognition instantly identifies registered
									vehicles without any action required.
								</p>
							</div>
						</div>
						<div className="flex flex-col items-center space-y-4 text-center">
					...
					<div className="grid gap-6 lg:grid-cols-3 lg:gap-8">
						<div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
							<div className="space-y-4">
								...
								<p className="text-gray-600">
									"I never have to worry about finding my parking card anymore.
									Just drive up and the gate opens. It's like magic!"
								</p>
						...
						<div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
							<div className="space-y-4">
								...
								<p className="text-gray-600">
									"Carla reduced our operational costs by 40% and eliminated all
									the issues with lost tickets and card readers."
								</p>
								<div className="flex items-center space-x-2">
						...
						<div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
							<div className="space-y-4">
								...
								<p className="text-gray-600">
									"The system works flawlessly even in bad weather. Our customers
					...
					<div className="flex flex-col items-center justify-center space-y-8 text-center">
						<div className="space-y-4">
							...
							<p className="max-w-[800px] text-gray-300 md:text-xl/relaxed">
								Cutting-edge recognition technology meets elegant simplicity. Our
								system learns, adapts, and improves with every interaction.
							</p>
						</div>
					...
					<div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
						<div className="space-y-6">
							<div className="space-y-2">
								...
								<p className="text-gray-600 md:text-lg">
									See measurable results from day one with reduced costs and
									improved efficiency
								</p>
							</div>
					...
					<div className="grid gap-6 lg:grid-cols-2 lg:gap-8 max-w-4xl mx-auto">
						<div className="space-y-4">
							...
							<p className="text-gray-600 text-sm">
								...
								registered license plates as vehicles approach, automatically
						...
						<div className="space-y-4">
							...
							<p className="text-gray-600 text-sm">
								Our system is designed to work in various conditions and can
								recognize plates even when partially obscured. It maintains 99.8%
								accuracy across different weather and lighting conditions.
							</p>
						</div>
						<div className="space-y-4">
							<h3 className="font-semibold">
							...
							<p className="text-gray-600 text-sm">
								...
								disruption to your parking operations. Our team handles everything
						...
						<div className="space-y-4">
							...
							<p className="text-gray-600 text-sm">
								...
								privacy regulations and only store the minimum information necessary
				...
				<div className="container mx-auto px-4 md:px-6">
					<div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
						<div className="space-y-4">
							...
							<p className="text-gray-600 md:text-lg">
								Join thousands of drivers who never worry about parking access
								again. Register your vehicle and discover the future of urban
								mobility.
							</p>
						...
						<div className="space-y-4">
							...
							<p className="text-gray-600 md:text-lg">
								Reduce costs, enhance security, and provide an exceptional
								experience for your customers. Discover how Carla can revolutionize
								your operations.
							</p>
							<div className="space-x-4">
								<Link href="/login">
