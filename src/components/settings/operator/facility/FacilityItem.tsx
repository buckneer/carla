...
import { Building2, Edit, Mail, MapPin, Phone, Settings, Users } from "lucide-react";
...
function FacilityItem({facility, handleEdit}: FacilityItemProps) {
	return (
		<div key={facility.id} className="bg-white rounded-lg shadow-sm border border-gray-200">
			<div className="p-6">
